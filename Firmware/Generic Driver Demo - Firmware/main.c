...
//      #pragma config ECCPMX   = DEFAULT
        ...
        //_CONFIG1( 0xFF7F & JTAGEN_OFF & GCP_OFF & GWRP_OFF & COE_OFF & FWDTEN_OFF & ICS_PGx2) 
        //_CONFIG2( FCKSM_CSDCMD & OSCIOFNC_OFF & POSCMOD_HS & FNOSC_PRIPLL & PLLDIV_DIV2 & IOL1WAY_ON)
        _CONFIG1(0x367F);
        _CONFIG2(0x13BE);
        _CONFIG3(0xFFFF);
    #else
...
//	to it in HardwareProfile.h.
    ...
    printf((const rom far char*) "Initializing System\r\n");
